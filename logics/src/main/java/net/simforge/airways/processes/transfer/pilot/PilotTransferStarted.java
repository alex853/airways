...
@Subscribe(PilotTransferStarted.class)
public class PilotTransferStarted implements Event, Handler {
    private static final Logger log = LoggerFactory.getLogger(PilotTransferStarted.class);
    ...
    @Override
    public void process() {
        BM.start("PilotTransferStarted.process");
